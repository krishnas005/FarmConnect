...
const SignInScreen = () => {
  ...
  return (
    <View className="flex-1 p-5 bg-white">
      ...
      {/* <View className="absolute top-5 left-5 flex-row items-center">
      ...
      <PhoneInput
        ...
        containerStyle={{ width: '100%', borderColor: '#D1D5DB', borderWidth: 1, borderRadius: 4, padding: 8, marginBottom: 10 }}
